...
class App:
    ...
    def GButton_192_command(self):
        ...
        m=[num1,num2,num3 ,num4 ,num5 ,num6 ,num7 ,num8,num9,num10 ,num11 ,num12 ,num13 ,num14 ,num15 ,num16 ,num17 ,num18 ,num19 ,num20 ,num21 ,num22]
        for i in m :
            self.v.append(i)
        w=final(self.b,self.v)
        root = tk.Tk()
